...
Generated by the prepare scripts, these contain the full extraction with all sensor channels, metadata, reference quaternions, and verification plots. Regenerable from source data.
